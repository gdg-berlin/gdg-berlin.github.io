...
boomerang.factory('Config',function(){
    return {
        //modify these
        'name'          : 'GDG Berlin',
        'id'            : '115635340252753847571',
        'google_api'    : 'AIzaSyAFI-Tg6uWgy5nRbD8pb41UQIg8w588qEg',
        'pwa_id'        : '5968366657189597889', //picasa web album id, must belong to google+ id above
        'cover' : {
            title : 'Google Developer Group Berlin',
            subtitle : 'Meet developers, share knowledge, have fun!',
            button : {
